...
class OrganizationController extends Uop_Controller_Organization
{
    ...
    {
        parent::showAction(); // TODO: Change the autogenerated stub
        $r_loc = $this->view->org->location();
        $this->view->search_form->getElement("loc_name")
            ->setUrl(Link::url("location-suggest")."?country_loc_id=". $r_loc->country_loc_id ."&query=");
        $this->view->search_form->getElement("search_loc_id")->setValue($r_loc->country_loc_id);
